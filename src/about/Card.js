  ...
  return (
    <div className="card" styles="width:18rem;">
      ...
      <div className="card-body">
        ...
        <div className="row align-items-center row-custom">
          <div className="col-sm-auto text-center">{props.other}</div>
        </div>

        <div className="row align-items-center row-custom">
          <div className="col-sm-auto text-center">{props.framework}</div>
        </div>

        <div className="row align-items-center row-custom">
          <div className="col-sm-auto text-center">{props.protocol}</div>
        </div>
      </div>
    </div>
  );
